...
\frac{\partial \mathcal{u}}{\partial \tau^2} &=  \frac{1}{2} \sum_{i=1}^k \left[ \left(\frac{(T_i - \mu)^2 - \left(\tau^2 + \sigma_i^2\right)}{\left(\tau^2 + \sigma_i^2\right)^2}\right) + \frac{c_i \phi(c_i)}{2 (\tau^2 + \sigma_i^2)} \left(\frac{1 - \beta_i - A_i}{\beta_i (1 - \beta_i)}\right)\right] 
\end{aligned}
$$ {#eq-pUs-scores}
