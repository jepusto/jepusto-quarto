...
\end{aligned}
$$ {#eq-diff-SE-varying}
where $\hat\pi_i = \frac{1 - \beta_i}{1 - (1 - \beta_i) \hat\lambda}$ is the probability of observing an affirmative result under the three-parameter selection model. The estimated selection parameter is defined by the constraint that $k_A = \sum_{i=1}^k \hat\pi_i$.
...
$$
\mathcal{l}_P(\mu, \tau) - \mathcal{l}_U(\mu, \tau) = k_N \bar\omega_A + k_A\bar\omega_A,
$$
