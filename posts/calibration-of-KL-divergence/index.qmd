...
Among other things, KL divergence is the basis of information criteria, including the Akaike [@Akaike1973information], Deviance [@Spiegelhalter2002bayesian], Watanabe [@Watanabe2010asymptotic], and LOO [@Vehtari2002bayesian] information criteria.[^BIC]
...
[^BIC]: As my colleague [David Kaplan](https://edpsych.education.wisc.edu/fac-staff/kaplan-david/) reminded me, the Bayesian Information Criterion [@Schwarz1978estimating] is a bit different from the others in that it is motivated as an approximation to the posterior probability of a given model, rather than as measure of predictive fit [@Gelman2014understanding].
...
&= -\frac{N}{2} \log\left(4 \pi(1 - \pi)\right).
\end{aligned}
$$
...
Put differently, the KL-divergence is driven by differences in the probability assigned to extreme outcomes.
