...
Let $\mat{V} = \mat{I} - \frac{1}{N^2}\mat{1}\mat{1}'$. 
...
&= \left(1 - \frac{1}{N^2}\right)\left(\sum_{a,b,c,d,z} \sigma_{abcdz}^2\right) + SS_{Total}.
\end{aligned}
$$
Thus, an unbiased estimator for the total sum of squares is
$$
SSA_{Total} = \widehat{SS}_{Total} - \left(1 - \frac{1}{N^2}\right)\sum_{a,b,c,d,z} \sigma_{abcdz}^2.
$$
