...
$$
\begin{aligned}
\Var\left(\widehat{SS}_q\right) &= \trace\left(\mat{P}_q \mat{P}_q' \bs\Sigma \mat{P}_q \mat{P}_q' \bs\Sigma \right) + \bs\Upsilon'\mat{P}_q \mat{P}_q' \bs\Sigma \mat{P}_q \mat{P}_q' \bs\Upsilon \\
&= \trace\left(\bs\Omega_q \bs\Omega_q \right) + \mat{b}_q' \bs\Omega_q \mat{b}_q.
\end{aligned}
$$
A feasible estimator of $\Var(SS_q)$ can be computed by substituting the estimated effects $\bs{\hat\theta}_q$ in place of the parameter vector $\bs\theta_q$. 
...
$$
\begin{aligned}
\Cov\left(\widehat{SS}_q, \widehat{SS}_r\right) &= \trace\left(\mat{P}_q \mat{P}_q' \bs\Sigma \mat{P}_r \mat{P}_r' \bs\Sigma \right) + \bs\Upsilon'\mat{P}_q\mat{P}_q' \bs\Sigma \mat{P}_r \mat{P}_r' \bs\Upsilon \\
&= \trace\left(\bs\Omega_{qr} \bs\Omega_{qr}' \right) + \mat{b}_q' \bs\Omega_{qr} \mat{b}_r,
\end{aligned}
$$
