---
title: 'Augmentative and Alternative Communication intervention targets for school-aged
  participants with ASD and ID: A single-case systematic review and meta-analysis'
author:
- name:
    given: Jay B.
    family: Ganz
...
- icon: unlock-fill
  text: Pre-Print
  url: https://edarxiv.org/yx5au/
- icon: code-slash
  text: Code
  url: https://osf.io/r5tjd/
- icon: table
  text: Data
