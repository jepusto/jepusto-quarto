---
title: 'Between-case standardized mean differences: Flexible methods for single-case
  designs'
author:
- name:
    given: Man
...
- hierarchical models
- multivariate
image-alt: Clustered multiple baseline design data from Bryant et al. (2018)
links:
- text: Journal
