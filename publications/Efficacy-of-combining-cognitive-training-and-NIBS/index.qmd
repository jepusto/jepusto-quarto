---
title: 'The efficacy of combining cognitive training and non-invasive brain stimulation:
  A transdiagnostic systematic review and meta-analysis'
author:
- name:
    given: Anika
    family: Poppe
...
- icon: unlock-fill
  text: Pre-Print
  url: https://psyarxiv.com/wqrne/
- icon: code-slash
  text: Code
  url: https://osf.io/qfpba/
- icon: table
  text: Data
  url: https://osf.io/h6yta
citation:
